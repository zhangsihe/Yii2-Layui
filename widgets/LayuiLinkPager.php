...
class LayuiLinkPager extends LinkPager{
    ...
    protected function renderPageButton($label, $page, $class, $disabled, $active)
    {
        ...
        if ($active) {
            ...
            return Html::tag('span', Html::tag('em', '', ['class' => 'layui-laypage-em']) . Html::tag('em', $label), $options);
        }
        if ($disabled) {
            Html::addCssClass($options, $this->disabledPageCssClass);
            $tag = ArrayHelper::remove($this->disabledListItemSubTagOptions, 'tag', 'span');

            return Html::a($label, '#',$this->disabledListItemSubTagOptions);
        }
